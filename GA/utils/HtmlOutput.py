...
class HtmlOutput:
    ...
    COLOR2 = "#CE0000"
    CRITERIAS = ('R', 'S', 'L', 'P', 'G')
    OK_DESCR = ("В текущей аудитории нет пересечений по времени", "В текущей аудитории достаточно мест",
                "В текущей аудитории достаточно компьютеров, если они требуются",
                "У преподавателей нет пересекающихся занятий", "У студенческих групп нет пересекающихся занятий")
    FAIL_DESCR = ("В текущей аудитории есть пересечения по времени", "В текущей аудитории недостаточно мест",
                "В текущей аудитории недостаточно компьютеров, если они требуются",
                "У преподавателей есть пересекающиеся занятия", "У студенческих групп есть пересекающиеся занятия")
    PERIODS = (
